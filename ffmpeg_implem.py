...
def get_loudness(file_location):
    ...
    loudness_range_Threshold = loudness_range.split("Threshold:", 1)[1].split("LRA low:", 1)[0].split("LUFS", 1)[
        0].strip()
...
out = get_loudness("187.mp3")
print(out.get('Integrated Loudness').get('I'))