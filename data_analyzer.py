...
class DataAnalyzer:
    ...
    def calculate_genre_euclidean_distance(self, track_path):
        if not os.path.isfile(Path(track_path)):
        ...
        for genre, values in self.genres_database.iterrows():
            # Genre parameters
            genre_values = [values.lufs, values.tp]
